    ...
    <>
      ...
      <div className="bg-white lg:p-40 p-5 pt-36">
        ...
        <p className="text-justify  mb-3">
          ...
          kiếm của bạn trong hệ thống, mục đích của việc lưu trữ này là để chúng
          tôi nâng cao chất lượng tìm kiếm lần sau được chính xác hơn, phù hợp
        ...
        <p className="text-justify  mb-3">
          Thông thường, chúng tôi sử dụng các thông tin bạn cung cấp chỉ để liên
          hệ, hồi đáp những câu hỏi hay thực hiện các yêu cầu của bạn. Thông tin
          cá nhân của bạn, những dữ liệu, hình ảnh về y tế, sức khỏe, hồ sơ của
          bạn có thể được chia sẻ đến bác sĩ, bệnh viện, cơ sở y tế trong trường
          hợp bạn đồng ý nhằm phục vụ bạn được tốt nhất.
        </p>
        <p className="text-justify  mb-3">
        ...
        <p className="text-justify  mb-3">
          ...
          thừa hay người được chỉ định để quản lý côngty khi công ty bị sát
        ...
        <p className="text-justify  mb-3">
          ...
          trong một website/ứng dụng. Chúng tôi sử dụng cookies để ghi chép các
          hoạt động của người sử dụng hay mục đích của người sử dụng không muốn
          xem cùng nội dung quảng cáo được lặp đi lặp lại nhiều lần. Ngoài ra,
          chúng tôi cũng sử dụng cookies để đáp ứng các yêu cầu của người sử
          dụng và các mục đích khác.
        </p>
        <p className="text-justify  mb-3">
        ...
        <p className="text-justify  mb-3">
          ...
          thường xuyên xác nhận để biết về các điều khoản thay đổi trong bản quy
          ...
          . Khi bạn tiếp tục sử dụng website/ứng dụng này, có nghĩa là bạn đồng
          ý và chấp nhận bị ràng buộc với các thay đổi trong bản quy định bảo
          mật trực tuyến này.
        </p>
